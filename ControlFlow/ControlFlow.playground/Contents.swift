...
var movieDict:[String:String] = ["Star Wars": "George Lucas", "Point Break": "Kathryn Bigelow", "When Harry Met Sally": "Rob Reiner", "The Dark Knight": "Christopher Nolan"]
...
for (index, item) in [10, 20, 30].enumerated() {
	print(index, item)
}
//:     for item in Collection {
//:         statements to execute on each item
